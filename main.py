...
async def on_message(message):
    ...
    if message.content.startswith('$hello'):
        await message.channel.send(f'Merhaba Kardeşim {client.user}! ben bir botum!')
    elif message.content.startswith('$bye'):
        await message.channel.send("Yine_Bekleriz_Kardesim")
    elif message.content.startswith('$Nasilsin'):
        await message.channel.send("İyi_Sen?")
